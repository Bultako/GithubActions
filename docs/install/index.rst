...
.. code-block:: bash
    ...
    curl -O https://gammapy.org/download/install/gammapy-0.27-environment.yml
    conda env create -f gammapy-0.27-environment.yml
...
.. code-block:: bash
    ...
    gammapy download notebooks --release 0.27
