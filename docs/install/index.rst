...
.. code-block:: bash
    ...
    curl -O https://gammapy.org/download/install/gammapy-0.7-environment.yml
    conda env create -f gammapy-0.7-environment.yml
...
This creates a conda environment called ``gammapy-0.7`` which you can activate via:

.. code-block:: bash

    conda activate gammapy-0.7
...
.. code-block:: bash
    ...
    gammapy download notebooks --release 0.7
